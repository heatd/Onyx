	...
	void)
{
	...
	while (sci_handler) {
		...
		int_status |= sci_handler->address (
			sci_handler->context);
	...
	void)
{
	...
	status = acpi_os_install_interrupt_handler ((u32) acpi_gbl_FADT.sci_interrupt,
	...
	void)
{
	...
	status = acpi_os_remove_interrupt_handler ((u32) acpi_gbl_FADT.sci_interrupt,
		acpi_ev_sci_xrupt_handler);
