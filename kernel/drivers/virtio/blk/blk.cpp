...
{
    blk_features::size_max,
    blk_features::seg_max,
    blk_features::geometry,
    blk_features::ro,
    blk_features::blk_size,
    blk_features::topology,
    blk_features::discard,
    blk_features::write_zeroes
};
...
int blk_vdev::submit_request(struct bio_req *req)
{
    ...
    alloc_info.fill_function = [](size_t vec_nr, virtio_allocation_info &context) -> virtio_desc_info
    {
        page_iov v;
