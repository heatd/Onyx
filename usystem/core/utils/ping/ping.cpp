...
std::pair<std::unique_ptr<unsigned char[]>, size_t> icmp_header(bool v6, std::uint16_t id,
                                                                std::uint16_t seq)
{
...
icmp_pkt_check_res icmp_check_response(unsigned char *header, unsigned char *payload,
                                       std::uint16_t seq, size_t size, std::uint16_t id,
                                       unsigned char *desired_payload, bool v6)
{
    if (v6)
    {
