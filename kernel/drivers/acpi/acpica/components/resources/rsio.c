...
struct acpi_rsconvert_info    acpi_rs_get_start_dpf[6] =
{
	...
	{ACPI_RSC_2BITFLAG, ACPI_RS_OFFSET (data.start_dpf.compatibility_priority),
			   AML_OFFSET (start_dpf.flags),
			   0},

	{ACPI_RSC_2BITFLAG, ACPI_RS_OFFSET (data.start_dpf.performance_robustness),
			   AML_OFFSET (start_dpf.flags),
			   2}
};
...
struct acpi_rsconvert_info    acpi_rs_set_start_dpf[10] =
{
	...
	{ACPI_RSC_LENGTH,   0, 0, sizeof (struct aml_resource_start_dependent_noprio)},
