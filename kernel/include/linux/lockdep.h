...
extern void lockdep_set_selftest_task(struct thread *task);

extern void lockdep_init_task(struct thread *task);
...
static inline void lockdep_init_task(struct thread *task)
{
}
...
static inline void lockdep_set_selftest_task(struct thread *task)
{
}
...
#ifdef CONFIG_PROVE_LOCKING
extern void print_irqtrace_events(struct thread *curr);
#else
static inline void print_irqtrace_events(struct thread *curr)
{
}
#endif
