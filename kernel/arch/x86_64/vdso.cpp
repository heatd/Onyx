...
public:
	vdso(Elf64_Ehdr *start, size_t length) : vdso_start{start}, length{length}, vmo{nullptr},
	                                         vdso_setup{false}, clock_monotonic{nullptr}, clock_realtime{nullptr}
	{}

	vdso() : vdso_start{nullptr}, length{0}, vmo{nullptr},
	         vdso_setup{false}, clock_monotonic{nullptr}, clock_realtime{nullptr}
	{}
