...
static driver serial_platform_driver = 
{
	.name = "uart8250-platform",
...
bool uart8250_port::early_init()
{
	...
	// Note: UART8250_MCR_GPO2_ENABLE = Enable interrupts as well. It's weird, but we also need to set this.
