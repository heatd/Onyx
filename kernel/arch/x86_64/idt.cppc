...
void init_idt()
{
	...
	/* TODO: Replace the interrupt vector for syscall or sysenter */
	idt_create_descriptor(0x80, (uint64_t) _syscall, 0x08, 0x8E);	/* System call interrupt */
	idt_create_descriptor(0x50, (uint64_t) _yield, 0x08, 0x8E);	/* Yield */
	load_idt();
}
