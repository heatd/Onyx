...
#include <stdint.h>
#include <kernel/mm.h>
static void* data_area_limit = nullptr;
static void* data_area_start = nullptr;
...
int __brk(void* addr)
{
	...
	// If the new limit is lesser than 0x400000 ( 4 MiB )or bigger than 0x80000000 ( 2 GiB ), its invalid
