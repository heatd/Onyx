...
void platform_init_acpi(void)
{
    ...
    {
        x86_platform.has_legacy_devices = (bool)(fadt->BootFlags & ACPI_FADT_LEGACY_DEVICES);
    }
    ...
    {
        x86_platform.has_vga = (bool)!(fadt->BootFlags & ACPI_FADT_NO_VGA);
        x86_platform.has_msi = (bool)!(fadt->BootFlags & ACPI_FADT_NO_MSI);
    }
