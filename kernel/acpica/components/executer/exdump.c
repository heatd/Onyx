...
static struct acpi_exdump_info      acpi_ex_dump_device[4] =
{
	...
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (device.notify_list[0]),        "System Notify"},
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (device.notify_list[1]),        "Device Notify"},
...
static struct acpi_exdump_info      acpi_ex_dump_method[9] =
{
	...
	{ACPI_EXD_UINT8,    ACPI_EXD_OFFSET (method.param_count),           "Parameter Count"},
...
static struct acpi_exdump_info      acpi_ex_dump_mutex[6] =
{
	...
	{ACPI_EXD_UINT8,    ACPI_EXD_OFFSET (mutex.original_sync_level),    "Original Sync Level"},
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (mutex.owner_thread),           "Owner Thread"},
	{ACPI_EXD_UINT16,   ACPI_EXD_OFFSET (mutex.acquisition_depth),      "Acquire Depth"},
...
static struct acpi_exdump_info      acpi_ex_dump_power[6] =
{
	...
	{ACPI_EXD_UINT32,   ACPI_EXD_OFFSET (power_resource.system_level),  "System Level"},
	{ACPI_EXD_UINT32,   ACPI_EXD_OFFSET (power_resource.resource_order), "Resource Order"},
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (power_resource.notify_list[0]), "System Notify"},
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (power_resource.notify_list[1]), "Device Notify"},
...
static struct acpi_exdump_info      acpi_ex_dump_processor[7] =
{
	...
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (processor.notify_list[0]),     "System Notify"},
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (processor.notify_list[1]),     "Device Notify"},
...
static struct acpi_exdump_info      acpi_ex_dump_thermal[4] =
{
	...
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (thermal_zone.notify_list[0]),  "System Notify"},
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (thermal_zone.notify_list[1]),  "Device Notify"},
...
static struct acpi_exdump_info      acpi_ex_dump_buffer_field[3] =
{
	...
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (buffer_field.buffer_obj),      "Buffer Object"}
};
...
static struct acpi_exdump_info      acpi_ex_dump_region_field[5] =
{
	...
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (field.resource_buffer),        "ResourceBuffer"}
};
...
static struct acpi_exdump_info      acpi_ex_dump_bank_field[5] =
{
	...
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (bank_field.region_obj),        "Region Object"},
...
static struct acpi_exdump_info      acpi_ex_dump_index_field[5] =
{
	...
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (index_field.index_obj),        "Index Object"},
...
static struct acpi_exdump_info      acpi_ex_dump_reference[9] =
{
	...
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (reference.index_pointer),      "Index Pointer"},
	{ACPI_EXD_REFERENCE,0,                                              NULL}
};

static struct acpi_exdump_info      acpi_ex_dump_address_handler[6] =
{
	{ACPI_EXD_INIT,     ACPI_EXD_TABLE_SIZE (acpi_ex_dump_address_handler), NULL},
	{ACPI_EXD_UINT8,    ACPI_EXD_OFFSET (address_space.space_id),       "Space Id"},
	{ACPI_EXD_HDLR_LIST,ACPI_EXD_OFFSET (address_space.next),           "Next"},
	{ACPI_EXD_RGN_LIST, ACPI_EXD_OFFSET (address_space.region_list),    "Region List"},
...
static struct acpi_exdump_info      acpi_ex_dump_extra[6] =
{
	...
	{ACPI_EXD_POINTER,  ACPI_EXD_OFFSET (extra.region_context),         "Region Context"},
...
static struct acpi_exdump_info      acpi_ex_dump_common[5] =
{
	...
	{ACPI_EXD_UINT16,   ACPI_EXD_OFFSET (common.reference_count),       "Reference Count"},
...
static struct acpi_exdump_info      acpi_ex_dump_field_common[7] =
{
	...
	{ACPI_EXD_UINT8,    ACPI_EXD_OFFSET (common_field.field_flags),     "Field Flags"},
	{ACPI_EXD_UINT8,    ACPI_EXD_OFFSET (common_field.access_byte_width), "Access Byte Width"},
	{ACPI_EXD_UINT32,   ACPI_EXD_OFFSET (common_field.bit_length),      "Bit Length"},
	{ACPI_EXD_UINT8,    ACPI_EXD_OFFSET (common_field.start_field_bit_offset),"Field Bit Offset"},
	{ACPI_EXD_UINT32,   ACPI_EXD_OFFSET (common_field.base_byte_offset), "Base Byte Offset"},
	...
	struct acpi_exdump_info         *info)
{
	...
	while (count) {
		...
		case ACPI_EXD_ADDRESS:
			...
			acpi_ex_out_pointer (name, *ACPI_CAST_PTR (void *, target));
			break;
		...
		case ACPI_EXD_FIELD:
			...
			acpi_ex_dump_object (obj_desc, acpi_ex_dump_field_common);
			break;

		case ACPI_EXD_REFERENCE:

			acpi_ex_out_string ("Class Name", acpi_ut_get_reference_name (obj_desc));
		...
		case ACPI_EXD_LIST:
			...
			if (next) {
				acpi_os_printf ("%s (Type %2.2X)",
					acpi_ut_get_object_type_name (next), next->common.type);
		...
		case ACPI_EXD_HDLR_LIST:
			...
			if (next) {
				acpi_os_printf ("(%s %2.2X)",
					acpi_ut_get_object_type_name (next),
		...
		case ACPI_EXD_NODE:
			...
			node = *ACPI_CAST_PTR (struct acpi_namespace_node *, target);
	...
	u32                             depth)
{
	...
	if (depth > 0) {
		ACPI_DEBUG_PRINT ((ACPI_DB_EXEC, "%*s[%u] %p Refs=%u ",
			depth, " ", depth, obj_desc, obj_desc->common.reference_count));
	}
	else {
	...
	case ACPI_TYPE_LOCAL_REFERENCE:
		...
		case ACPI_REFCLASS_REFOF:
			...
			acpi_os_printf ("%p [%s]\n", obj_desc->reference.object,
				acpi_ut_get_type_name (((union acpi_operand_object *)
					obj_desc->reference.object)->common.type));
			break;

		case ACPI_REFCLASS_NAME:

			acpi_ut_repair_name (obj_desc->reference.node->name.ascii);
	...
	case ACPI_TYPE_PACKAGE:
		...
		if (obj_desc->package.count &&
			...
			for (index = 0; index < obj_desc->package.count; index++) {
				acpi_ex_dump_operand (
					obj_desc->package.elements[index], depth + 1);
			}
		}
		break;
	...
	case ACPI_TYPE_LOCAL_REGION_FIELD:
		...
		acpi_os_printf ("RegionField: Bits=%X AccWidth=%X Lock=%X Update=%X at "
	...
	union acpi_operand_object       *obj_desc)
{
	...
	if (obj_desc->reference.class == ACPI_REFCLASS_NAME) {
		...
		if (ACPI_FAILURE (status)) {
			...
			acpi_os_printf ("%s: %s\n",
				acpi_ut_get_type_name (obj_desc->reference.node->type),
	...
	u32                             index)
{
	...
	case ACPI_TYPE_BUFFER:
		...
		if (obj_desc->buffer.length) {
			acpi_ut_debug_dump_buffer (
				ACPI_CAST_PTR (u8, obj_desc->buffer.pointer),
	...
	case ACPI_TYPE_PACKAGE:
		...
		for (i = 0; i < obj_desc->package.count; i++) {
			acpi_ex_dump_package_obj (
				obj_desc->package.elements[i], level + 1, i);
		}
		break;
