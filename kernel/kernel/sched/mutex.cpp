...
bool __mutex_trylock(mutex *lock)
{
	...
	return __atomic_compare_exchange_n(&lock->counter, &expected, word, false,
...
bool mutex_test(void)
{
	...
	{
		auto thread = sched_create_thread(mutex_thread_entry, THREAD_KERNEL, (void *) (unsigned long) i);
